const constants = {
    ...
    anomaly_t21: "T21 - Down's Syndrome",
    fasp_criteria: {
        'Anencephaly': {
    ...
    validations: {
        common: [
            "Probable or confirmed FASP anomaly",
            "Estimated date of delivery (EDD)",
        ],
        'combined': [
            "Combined test (Including numeric risks and lab code)",
        ],
        'Declined Screening': [
            'Screening acceptance on pregnancy page',
        ],
        'FA Scan': [
            'Fetal anomaly scan',
            'Recall fetal anomaly scan (if performed).'
        ],
        'Ineligible: Early Diagnosis': [
            'First suspected date (unless private)'
        ],
        'Quad': [
            "Quad test (Including numeric risks and lab code)",
        ],
        'NT measurable': [
            "Combined test event",
            "Combined test status = <u>'Failed/Incomplete/Inconclusive (Non-Genetic Test)'</u>",
            "Combined test NT is populated."
        ],
        'NT not measurable': [
            "Combined test event",
            "Combined test status = <u>'Failed/Incomplete/Inconclusive (Non-Genetic Test)'</u>",
